...
translation_tables = {
    "de": {
        ...
        "Energy consumption [kWh]": "Energiebedarf [kWh]",
        "Feasibility of rotations per charging type": "Machbarkeit der Umläufe je Ladetyp",
        "fixed load [kW]": "Feste Last [kW]",
        "grid supply [kW]": "Netzanschlusspunkt [kW]",
        "Inside window": "Innerhalb des HLZ",
        "local generation [kW]": "lokale Erzeugung [kW]",
        ...
        "Power": "Leistung",
        "price [ct/kWh]": "Strompreis [ct/kWh]",
        "stored battery energy [kWh]": "Batterie Energieinhalt [kWh]",
        "successful rotations": "Erfolgreiche Umläufe",
        "sum CS power [kW]": "Ladestationen [kW]",
