...
if __name__ == '__main__':
    ...
    args.output_directory_input = Path(args.output_directory) / "input_data"
    ...
    for c_file in copy_list:
        shutil.copy(str(c_file), str(args.output_directory_input / Path(c_file).name))

    util.save_version(Path(args.output_directory_input / "program_version.txt"))
